...
if(isset($_POST['btn-deposit'])){
  ...
  $plan = 'Silver Plan';
  $invest_range = '$500,000 - UNLIMITED';
									...
									<div class="card-body">
										...
										<nav aria-label="breadcrumb">
											<ol class="breadcrumb breadcrumb-inverse">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">SilverPlan</li>
											</ol>
                    </nav>
                    ...
                    <div class="card-body">
                        <form class="form-pill" method='POST' action=''>
                            <div class="form-group">
                                ...
                                <input type="number" min='100000' max='499999' name='amount' class="form-control" id="exampleFormControlInput3" placeholder="Enter Amount">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlPassword3">Investment Plan</label>
                                <input type="text" name='plan' class="form-control" id="exampleFormControlPassword3" value='Silver Plan' disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name='invest_range' class="form-control" id="exampleFormControlPassword3" value='$100,000 - $499,999' disabled>
                            </div>
