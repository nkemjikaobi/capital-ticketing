...
@section('title', 'Edit Soccer Pays')
    ...
    <div class="card-body">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-inverse">
                ...
                <li class="breadcrumb-item active-span" aria-current="page">Edit Soccer Pays</li>
            </ol>
        </nav>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-default">
                <div class="card-header card-header-border-bottom">
                    <h2>Edit Soccer Pays</h2>
                </div>
                <div class="card-body">
                    <form class="form-pill" method='POST' action="/admin/soccer/pays/edit">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-footer">
                            <button type="submit"  name='btn-update' class="btn btn-ticket btn-default">Update Soccer Pay</button>
                        </div>
                    </form>
                </div>
            </div>
