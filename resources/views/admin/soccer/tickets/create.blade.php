...
@section('title', 'Add Soccer Ticket')
    ...
    <div class="card-body">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-inverse">
                ...
                <li class="breadcrumb-item active-span" aria-current="page">Add Soccer Ticket</li>
            </ol>
        </nav>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-default">
                <div class="card-header card-header-border-bottom">
                    <h2>Add Soccer Ticket</h2>
                </div>
                <div class="card-body">
                    <form class="form-pill" method='POST' enctype="multipart/form-data" action="/admin/soccer/add">
                        @csrf
                        ...
                        <div class="form-footer">
                            <button type="submit"  name='btn-add' class="btn btn-ticket btn-default">Add Soccer Ticket</button>
                        </div>
                    </form>
                </div>
            </div>
