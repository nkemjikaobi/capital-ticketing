...
@section('title', 'Edit Soccer Ticket')
    ...
    <div class="card-body">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-inverse">
                ...
                <li class="breadcrumb-item active-span" aria-current="page">Edit Soccer Ticket</li>
            </ol>
        </nav>
                ...
                <div class="card-body">
                    <form class="form-pill" method='POST' action="/admin/soccer/edit">
                        ...
                        <div class="form-footer">
                            <button type="submit"  name='btn-update' class="btn btn-ticket btn-default">Update Soccer Ticket</button>
                        </div>
                    </form>
                </div>
            </div>
