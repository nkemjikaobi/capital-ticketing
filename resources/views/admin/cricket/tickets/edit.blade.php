...
@section('title', 'Edit Cricket Ticket')
    ...
    <div class="card-body">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-inverse">
                ...
                <li class="breadcrumb-item active-span" aria-current="page">Edit Cricket Ticket</li>
            </ol>
        </nav>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-default">
                <div class="card-header card-header-border-bottom">
                    <h2>Edit Cricket Ticket</h2>
                </div>
                <div class="card-body">
                    <form class="form-pill" method='POST' action="/admin/cricket/edit" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-footer">
                            <button type="submit"  name='btn-update' class="btn btn-ticket btn-default">Update Cricket Ticket</button>
                        </div>
                    </form>
                </div>
            </div>
