...
@section('content')
        ...
        <div class="card-body">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-inverse">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="/buy_tickets/soccer" style="text-decoration: none !important;color:#4c84ff;">Cricket</a></li>
        ...
        <div class="card card-default">
            @foreach($pay as $p)
                ...
                <div class="card-body">
                    <form class="form-pill" method='POST' action='/buy_tickets/cricket/pay/process'>
                        @csrf
