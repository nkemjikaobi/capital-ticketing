...
@section('content')
        ...
        <div class="card-body">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-inverse">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="/buy_tickets/cricket" style="text-decoration: none !important;color:#4c84ff;">Cricket</a></li>
        ...
        <!-- Top Statistics -->
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form class="form-pill" method='POST' action='/buy_tickets/cricket/pay'>
                        @csrf
