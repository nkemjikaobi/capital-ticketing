...
@section('content')
        ...
        <div class="card-body">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-inverse">
                    ...
                    <li class="breadcrumb-item active-span" aria-current="page">Cricket</li>
                </ol>
            </nav>
        ...
        <div class='row'>
            @foreach($tickets as $ticket)
                    <div class="col-md-6">
                        <a href="/buy_tickets/cricket/{{$ticket->id}}/{{$ticket->home_team}}_{{$ticket->away_team}}" class="surround">
                            <div id='ticket'>
                                <div class='back'>
                                  <div class='left'>
                                    <div class="left-bar">
