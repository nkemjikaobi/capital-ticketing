...
@section('content')
        ...
        <div class="card-body">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-inverse">
                    ...
                    <li class="breadcrumb-item active-span" aria-current="page"><a href="/buy_tickets/football" style="text-decoration: none !important;color:#4c84ff;">FootBall</a></li>
                    <li class="breadcrumb-item active-span" aria-current="page"><a href="/buy_tickets/football/pay" style="text-decoration: none !important;color:#4c84ff;">Pay</a></li>
                </ol>
            </nav>
        ...
        <div class="card card-default">
            @foreach($pay as $p)
                ...
                <div class="card-body">
                    <form class="form-pill" method='POST' action='/buy_tickets/football/pay/process'>
                        @csrf
